...
@Builder
@PasswordMatches
@Schema(description = "Request payload for resetting a user's password after verifying the reset code.")
public class ResetPasswordRequest {
    ...
    @Schema(example = "New#Strong1", description = "Confirmation of the password")
